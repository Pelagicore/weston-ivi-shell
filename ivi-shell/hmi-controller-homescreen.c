...
static void touch_up(struct ivi_hmi_controller *hmi_ctrl, uint32_t id_surface)
{
    ...
    struct wlContextStruct *p_wlCtx, struct hmi_controller_srfInfo *srfInfo)
{
    ...
    ivi_hmi_controller_set_workspacebackground(p_wlCtx->cmm.hmiCtrl, srfInfo->id);
}
